...
namespace BingWallpaper.Utility
{
    public static class EnumExtensions
    {
        ...
        public static string ToDisplay(this Enum value, DisplayProperty property = DisplayProperty.Name)
        {
            ...
            {
                DisplayAttribute attr = attributes[0];
                object propValue = attr.GetType().GetProperty(property.ToString()).GetValue(attr, null);
        ...
        public static Dictionary<int?, string> ToDictionaryNullable<T>(this T value) where T : struct
        {
            ...
            Dictionary<int?, string> dic = new Dictionary<int?, string> { [-1] = "انتخاب" };
