...
namespace BingWallpaper.Utility
{
    public static class ValidationHelper
    {
        ...
        {
            Type type = ReflectionHelper.GetBaseType<T>();
        ...
        public static bool IsValidEmail(string email)
        {
            ...
            email = email.Trim();
            bool result = Regex.IsMatch(email, "^(?:[\\w\\!\\#\\$\\%\\&\\'\\*\\+\\-\\/\\=\\?\\^\\`\\{\\|\\}\\~]+\\.)*[\\w\\!\\#\\$\\%\\&\\'\\*\\+\\-\\/\\=\\?\\^\\`\\{\\|\\}\\~]+@(?:(?:(?:[a-zA-Z0-9](?:[a-zA-Z0-9\\-](?!\\.)){0,61}[a-zA-Z0-9]?\\.)+[a-zA-Z0-9](?:[a-zA-Z0-9\\-](?!$)){0,61}[a-zA-Z0-9]?)|(?:\\[(?:(?:[01]?\\d{1,2}|2[0-4]\\d|25[0-5])\\.){3}(?:[01]?\\d{1,2}|2[0-4]\\d|25[0-5])\\]))$", RegexOptions.IgnoreCase);
            return result;
        }
        ...
        public static bool IsNationalCode(this string nationalcode, out string msg)
        {
            try
            {
                char[] chArray = nationalcode.Trim().ToCharArray();
